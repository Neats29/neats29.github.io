...
<!-- ## [Chef vs Cook](https://waitbutwhy.com/2015/11/the-cook-and-the-chef-musks-secret-sauce.html) -->
...
He uses the analogy of cook vs chef to explain it. -->
...
<img src="/waitbutwhy/culinary.png"
    style="width: 100%;
    display: block;"
    alt="">
</img>
...
<img src="/waitbutwhy/human-colossus.png"
    style="width: 60%;
    display: block;"
    alt="">
</img>

The Human Colossus — the collective knowledge that humanity has built — is the idea that an individual is unable to create even a pencil on their own, but collectively and through our large body of accumulated knowledge we are able to land on the moon.
...
<img src="/waitbutwhy/panic-monster.png"
    style="width: 100%;
    display: block;"
    alt="">
</img>
...
<img src="/waitbutwhy/mammoth-1.png"
    style="width: 100%;
    display: block;"
    alt="">
</img>

<img src="/waitbutwhy/mammoth-2.png"
    style="width: 100%;
    display: block;"
    alt="">
</img>
...
---
<!-- 
<h1 style="font-size: 1.6em;">3-7</h1>

Last but not least, I going from step 3 to step 7. Step 10 being expert
Curious layman 
